...
MERGE INTO GENRE (GENRE_ID, NAME) KEY (GENRE_ID) VALUES (2, 'THRILLER');
MERGE INTO GENRE (GENRE_ID, NAME) KEY (GENRE_ID) VALUES (3, 'FICTION');
MERGE INTO GENRE (GENRE_ID, NAME) KEY (GENRE_ID) VALUES (4, 'DRAMA');
MERGE INTO GENRE (GENRE_ID, NAME) KEY (GENRE_ID) VALUES (5, 'HISTORICAL');
MERGE INTO GENRE (GENRE_ID, NAME) KEY (GENRE_ID) VALUES (6, 'MELODRAMA');
MERGE INTO GENRE (GENRE_ID, NAME) KEY (GENRE_ID) VALUES (7, 'ACTION');
MERGE INTO GENRE (GENRE_ID, NAME) KEY (GENRE_ID) VALUES (8, 'ADVENTURE');

--ЗАПОЛНЕНИЕ ТАБЛИЦЫ FILM_GENRE
MERGE INTO FILM_GENRE KEY (FILM_ID, GENRE_ID) VALUES (1, 3);
MERGE INTO FILM_GENRE KEY (FILM_ID, GENRE_ID) VALUES (1, 7);
MERGE INTO FILM_GENRE KEY (FILM_ID, GENRE_ID) VALUES (1, 4);
MERGE INTO FILM_GENRE KEY (FILM_ID, GENRE_ID) VALUES (1, 8);
MERGE INTO FILM_GENRE KEY (FILM_ID, GENRE_ID) VALUES (2, 3);
MERGE INTO FILM_GENRE KEY (FILM_ID, GENRE_ID) VALUES (2, 7);
MERGE INTO FILM_GENRE KEY (FILM_ID, GENRE_ID) VALUES (2, 4);
MERGE INTO FILM_GENRE KEY (FILM_ID, GENRE_ID) VALUES (2, 8);
